<!-- en-sha256: 148f84fe4671fe287f30994581f2cdc699bb1f8c8e3038bfab9d4e8288673831 leak-scan: ignore[high_entropy_hex] -->
<div align="center">
...
| **Hệ thống hoá các playbook tái dùng** | Một hệ skill có anatomy, tiers, registry, và **hai mươi** skill chạy được trên cả năm tier — mười hai **workflow**, bốn **guard**, một **meta** router, hai **feature**, một **audit** | [`.claude/skills/`](../.claude/skills/) |
...
biết cái nào thắng khi nhiều cái cùng khớp. Hai mươi skill chạy được ship như các tham chiếu hoạt
động:
...
| `awb-session-close` | workflow | kết phiên, "đóng an toàn chưa? / còn gì chưa commit không?" | Audit cây tìm việc lửng lơ (chưa commit / chưa push / chưa merge / branch cũ), dọn khi được duyệt |
| `awb-verify-docs` | feature | viết code dựa vào một thư viện/API cụ thể, "thư viện này có làm X không" | Neo code nhạy-version vào docs chính thức; trích nguồn hoặc đánh dấu UNVERIFIED |
...
| Tests | **845**, xanh trong CI (gồm cả ca né đối kháng cho command guard) |
...
**Agent Workbench** · lõi chỉ stdlib · 845 tests · MIT
