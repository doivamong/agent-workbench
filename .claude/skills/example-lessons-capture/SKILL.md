...
> **Announce on activation:** "Using example-lessons-capture — I'll mine this session for durable lessons, score them against a fixed bar, and write only what you approve to the live memory dir."
