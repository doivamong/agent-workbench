...
| **Encode reusable playbooks** | A skill system with anatomy, tiers, a registry, and **six** runnable example skills — four **workflows** (plan-then-code, prompt-refiner, research, handover) and two **guards** (review, debug) | [`.claude/skills/`](.claude/skills/) |
...
| Example skills | **6** (4 workflow + 2 guards) |
